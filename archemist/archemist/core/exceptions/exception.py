...
class AspirationVolumeBeyondLimitError(Error):
    def __init__(self):
        self.message = f'The aspiration volume provided is more than the aspiration capacity of rLine dispensing module!!!'

class DispensingVolumeBeyondCapacityError(Error):
    def __init__(self):
        self.message = f'The dispensing volume provided is beyond the capacity of rLine dispensing module!!!'
